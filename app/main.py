...
rule_engine = RuleEngine(
    settings.resolve_path(settings.seed_annexes_path),
    settings.resolve_path(settings.seed_concepts_path),
    settings.resolve_path(settings.seed_prohibitions_path),
)
